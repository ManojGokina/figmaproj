...
import NotificationCarousel from "../../Components/NotificationCarousel/NotificationCarousel";
    ...
    <div className="homePage">
      <div className="homeLeft">
        <div className="notificationCom">
          <div className="notificationComLeft">
            <div>
              <svg
          ...
          <div className="notificationComRight">
            <NotificationCarousel />
          </div>
        </div>
        <div className="middleSection">
          <div className="middleSectionLeft"></div>
        ...
        <div className="testimonials">
          ...
          <p className="testimonialCarouselSwipe">
            Swipe <IoIosArrowRoundForward />
          </p>
          <div className="lochLogo">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="60"
              height="60"
        ...
        <div className="signUpCom">
          ...
          <form
            onSubmit={(e) => {
              ...
              if (validator.isEmail(email)) {
                ...
                setEmail("");
                window.open("https://loch.one/welcome", "_blank");
              } else {
          ...
          >
            <input
              ...
              value={email}
            />
            {!isValidEmail ? <p>Please enter a valid email</p> : null}
